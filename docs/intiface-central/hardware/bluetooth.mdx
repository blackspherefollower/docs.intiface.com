...
However, **some toys from [WeVibe](/docs/intiface-central/hardware/wevibe) and [Satisfyer](/docs/intiface-central/hardware/satisfyer)** require dongles with a specific brand of radio. The dongle above should work for them, but other dongles may not. For more info on these devices, see their brand specific sections of the FAQ.
