...
![Intiface Central Startup Screen](/img/intiface-central/quickstart/intiface-1.png)
...
![Intiface Device Manager Settings](/img/intiface-central/quickstart/intiface-device-managers.png)
...
![Intiface Control Panel, Engine not started](/img/intiface-central/quickstart/intiface-control-panel-start.png)
...
![Intiface Control Panel, Engine started](/img/intiface-central/quickstart/intiface-control-panel-started.png)
...
![Intiface Control Panel w/ Update and Error Status](/img/intiface-central/quickstart/intiface-control-panel-update-error.png)
...
![IC Devices Panel](/img/intiface-central/quickstart/intiface-devices-panel.png)

No devices are connected yet. Let's change that! Hit the *Start Scanning* button at the top of the panel.

![IC Devices Panel w/ Connected Devices](/img/intiface-central/quickstart/intiface-devices-panel-connected.png)
...
For that, we'll connect... this quickstart! 

With the Engine running in IC, click on the two buttons below. You'll be able to see the system connect and disconnect from IC. It'll also show you what devices are currently connected, and allow you to run test events on them like vibration, rotation, or stroking.

:::warning Not done yet

The device control part isn't done yet. We've just got connect/disconnect so far. I'll get the rest of the controls in ASAP.
...
If you've made it this far with no errors, you're ready to use Intiface Central! The rest of the documentation goes over the UI in-depth, as well as advanced usages of IC, more information about different hardware connections, problems that are common with different brands of toys, and how to troubleshoot or get help if you run into issues.
